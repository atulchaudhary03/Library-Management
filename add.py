...
def add_db():
    ...
    sqlquery = "INSERT INTO books (bid, title, author) VALUES ('" + bid + "','" + btitle + "','" + bauthor + "');"
    print(sqlquery)
    ...
    try:
        ...
        messagebox.showinfo("Error", "Cannot add the given book data into the database")
...
def addBooks():
    ...
    submitbtn = Button(window, text="Submit", command=add_db, bg="DodgerBlue2", fg="white",
                       font=('arial', 15, 'bold'))
